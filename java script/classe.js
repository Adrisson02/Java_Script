...
let meuCarro1 = new Carro('Ford', 2014); let meuCarro2 = new Carro('Audi', 2019); 
...
console.clear(); class ClassePessoa {     constructor(firstName, lastName, dob) {         
...
console.clear();
//Constructor de função -  Lexicalo this 
function PessoaFunc(firstName, lasteName, dob) {
    this.firstName = firstName;
...
PessoaFunc.prototype.getBrithDayMonth = function () {
...
console.clear();
console.log(pessoa3.getBrithDayMonth());
