...
if (f > 5 && g > 10) 
console.log('f é maior do que 5 e g é maior do 10'); 
else {   
    console.log(`Condição é ${f > 5 && g > 10}`);     
...
if (ave % 2 == 0 && !isNaN(ave)) console.log('Número par!'); 
else if (ave % 2 != 0 && !isNaN(ave)) console.log('Número ímpar'); 
...
console.clear(); 
let resultado = 3 > 4 ? "Sim" : "Não"; console.log(resultado) 
...
switch (cor) {     
    case 'vermelha':         
console.log('A cor é vermelha');         break;     
case 'azul':         
console.log('A cor é azul');         break;     
default:         
