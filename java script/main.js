...
console.error('Essa é mensagem de erro');
...
const idade1 = 30;
 ...
 console.log(typeof nome_pessoa); // of const
 ...
 // Concatenar strings
 console.clear();
 const pessoa = 'irmão do Joreal';
 const idade2 = 30;
 console.log('Meu nome é ' + pessoa + ' e eu tenho ' + idade2 + ' anos');
// Template String 
const hello = `Meu nome é ${pessoa} eu tenho ${idade2} anos! ` ;
console.log(hello)
